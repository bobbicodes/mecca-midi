...
var G__18990 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__18990,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__18990;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq18992){
...
var file = cljs.core.get.call(null,map__18999__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__18999__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__18999__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__18999,map__18999__$1,file,line,column){
return (function (p1__18998_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__18998_SHARP_));
});})(map__18999,map__18999__$1,file,line,column))
...
var temp__5457__auto___19001 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___19001)){
var message_19002 = temp__5457__auto___19001;
cljs.core.println.call(null,message_19002);
} else {
}
...
var temp__5457__auto___19003 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___19003)){
var message_19004 = temp__5457__auto___19003;
cljs.core.println.call(null,message_19004);
} else {
}
...
var output_dir__$1 = (function (){var G__19005 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19005),"/"].join('');
} else {
return G__19005;
}
})();
...
var G__19007 = exception.stack;
var G__19007__$1 = (((G__19007 == null))?null:clojure.string.split_lines.call(null,G__19007));
var G__19007__$2 = (((G__19007__$1 == null))?null:cljs.core.get.call(null,G__19007__$1,depth));
if((G__19007__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__19007__$2);
}
} else {
...
var vec__19008 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__19008,(0),null);
var column = cljs.core.nth.call(null,vec__19008,(1),null);
var vec__19011 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__19011,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__19011,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__19011,(2),null);
...
var m__$1 = (function (){var G__19014 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__19018 = (function (){var G__19017 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__19017);
} else {
return G__19017;
}
})();
...
return cljs.core.vary_meta.call(null,G__19019,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__19023 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__19023,(0),null);
var types = vec__19023;
...
return cljs.core.map.call(null,(function (p__19026){
var vec__19027 = p__19026;
var ns = cljs.core.nth.call(null,vec__19027,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__19027,(1),null);
return ((function (vec__19027,ns,vars__$1){
return (function (){
...
var G__19030 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__19030,G__19030__$1,env,once_fixtures,each_fixtures,vec__19027,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__19030,G__19030__$1,env,once_fixtures,each_fixtures,vec__19027,ns,vars__$1){
return (function (){
var seq__19031 = cljs.core.seq.call(null,vars__$1);
var chunk__19032 = null;
var count__19033 = (0);
var i__19034 = (0);
while(true){
if((i__19034 < count__19033)){
var v = cljs.core._nth.call(null,chunk__19032,i__19034);
var temp__5457__auto___19036 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19036)){
var t_19037 = temp__5457__auto___19036;
each_fixture_fn.call(null,((function (seq__19031,chunk__19032,count__19033,i__19034,t_19037,temp__5457__auto___19036,v,each_fixture_fn,G__19030,G__19030__$1,env,once_fixtures,each_fixtures,vec__19027,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19037)));
});})(seq__19031,chunk__19032,count__19033,i__19034,t_19037,temp__5457__auto___19036,v,each_fixture_fn,G__19030,G__19030__$1,env,once_fixtures,each_fixtures,vec__19027,ns,vars__$1))
);
} else {
}


var G__19038 = seq__19031;
var G__19039 = chunk__19032;
var G__19040 = count__19033;
var G__19041 = (i__19034 + (1));
seq__19031 = G__19038;
chunk__19032 = G__19039;
count__19033 = G__19040;
i__19034 = G__19041;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__19031);
if(temp__5457__auto__){
var seq__19031__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19031__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__19031__$1);
var G__19042 = cljs.core.chunk_rest.call(null,seq__19031__$1);
var G__19043 = c__4351__auto__;
var G__19044 = cljs.core.count.call(null,c__4351__auto__);
var G__19045 = (0);
seq__19031 = G__19042;
chunk__19032 = G__19043;
count__19033 = G__19044;
i__19034 = G__19045;
continue;
} else {
var v = cljs.core.first.call(null,seq__19031__$1);
var temp__5457__auto___19046__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19046__$1)){
var t_19047 = temp__5457__auto___19046__$1;
each_fixture_fn.call(null,((function (seq__19031,chunk__19032,count__19033,i__19034,t_19047,temp__5457__auto___19046__$1,v,seq__19031__$1,temp__5457__auto__,each_fixture_fn,G__19030,G__19030__$1,env,once_fixtures,each_fixtures,vec__19027,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19047)));
});})(seq__19031,chunk__19032,count__19033,i__19034,t_19047,temp__5457__auto___19046__$1,v,seq__19031__$1,temp__5457__auto__,each_fixture_fn,G__19030,G__19030__$1,env,once_fixtures,each_fixtures,vec__19027,ns,vars__$1))
);
} else {
}


var G__19048 = cljs.core.next.call(null,seq__19031__$1);
var G__19049 = null;
var G__19050 = (0);
var G__19051 = (0);
seq__19031 = G__19048;
chunk__19032 = G__19049;
count__19033 = G__19050;
i__19034 = G__19051;
continue;
}
} else {
...
});})(each_fixture_fn,G__19030,G__19030__$1,env,once_fixtures,each_fixtures,vec__19027,ns,vars__$1))
);
});})(each_fixture_fn,G__19030,G__19030__$1,env,once_fixtures,each_fixtures,vec__19027,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19030__$1)].join('')));

}
})());
});
;})(vec__19027,ns,vars__$1))
