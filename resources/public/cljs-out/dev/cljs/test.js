...
return cljs.core.assoc.call(null,G__18977,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__18977;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq18979){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18980,G__18981,seq18979__$2);
});
...
var file = cljs.core.get.call(null,map__18986__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__18986__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__18986__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__18986,map__18986__$1,file,line,column){
return (function (p1__18985_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__18985_SHARP_));
});})(map__18986,map__18986__$1,file,line,column))
...
var temp__5457__auto___18988 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___18988)){
var message_18989 = temp__5457__auto___18988;
cljs.core.println.call(null,message_18989);
} else {
}
...
var output_dir__$1 = (function (){var G__18992 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__18992),"/"].join('');
} else {
return G__18992;
}
})();
...
var G__18994 = exception.stack;
var G__18994__$1 = (((G__18994 == null))?null:clojure.string.split_lines.call(null,G__18994));
var G__18994__$2 = (((G__18994__$1 == null))?null:cljs.core.get.call(null,G__18994__$1,depth));
if((G__18994__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__18994__$2);
}
} else {
...
var vec__18995 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__18995,(0),null);
var column = cljs.core.nth.call(null,vec__18995,(1),null);
var vec__18998 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__18998,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__18998,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__18998,(2),null);
...
var m__$1 = (function (){var G__19001 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__19005 = (function (){var G__19004 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__19004);
} else {
return G__19004;
}
})();
...
return cljs.core.vary_meta.call(null,G__19006,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__19010 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__19010,(0),null);
var types = vec__19010;
...
return cljs.core.map.call(null,(function (p__19013){
var vec__19014 = p__19013;
var ns = cljs.core.nth.call(null,vec__19014,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__19014,(1),null);
return ((function (vec__19014,ns,vars__$1){
return (function (){
...
var G__19017 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__19017,G__19017__$1,env,once_fixtures,each_fixtures,vec__19014,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__19017,G__19017__$1,env,once_fixtures,each_fixtures,vec__19014,ns,vars__$1){
return (function (){
var seq__19018 = cljs.core.seq.call(null,vars__$1);
var chunk__19019 = null;
var count__19020 = (0);
var i__19021 = (0);
while(true){
if((i__19021 < count__19020)){
var v = cljs.core._nth.call(null,chunk__19019,i__19021);
var temp__5457__auto___19023 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19023)){
var t_19024 = temp__5457__auto___19023;
each_fixture_fn.call(null,((function (seq__19018,chunk__19019,count__19020,i__19021,t_19024,temp__5457__auto___19023,v,each_fixture_fn,G__19017,G__19017__$1,env,once_fixtures,each_fixtures,vec__19014,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19024)));
});})(seq__19018,chunk__19019,count__19020,i__19021,t_19024,temp__5457__auto___19023,v,each_fixture_fn,G__19017,G__19017__$1,env,once_fixtures,each_fixtures,vec__19014,ns,vars__$1))
);
} else {
}


var G__19025 = seq__19018;
var G__19026 = chunk__19019;
var G__19027 = count__19020;
var G__19028 = (i__19021 + (1));
seq__19018 = G__19025;
chunk__19019 = G__19026;
count__19020 = G__19027;
i__19021 = G__19028;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__19018);
if(temp__5457__auto__){
var seq__19018__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19018__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__19018__$1);
var G__19029 = cljs.core.chunk_rest.call(null,seq__19018__$1);
var G__19030 = c__4351__auto__;
var G__19031 = cljs.core.count.call(null,c__4351__auto__);
var G__19032 = (0);
seq__19018 = G__19029;
chunk__19019 = G__19030;
count__19020 = G__19031;
i__19021 = G__19032;
continue;
} else {
var v = cljs.core.first.call(null,seq__19018__$1);
var temp__5457__auto___19033__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19033__$1)){
var t_19034 = temp__5457__auto___19033__$1;
each_fixture_fn.call(null,((function (seq__19018,chunk__19019,count__19020,i__19021,t_19034,temp__5457__auto___19033__$1,v,seq__19018__$1,temp__5457__auto__,each_fixture_fn,G__19017,G__19017__$1,env,once_fixtures,each_fixtures,vec__19014,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19034)));
});})(seq__19018,chunk__19019,count__19020,i__19021,t_19034,temp__5457__auto___19033__$1,v,seq__19018__$1,temp__5457__auto__,each_fixture_fn,G__19017,G__19017__$1,env,once_fixtures,each_fixtures,vec__19014,ns,vars__$1))
);
} else {
}


var G__19035 = cljs.core.next.call(null,seq__19018__$1);
var G__19036 = null;
var G__19037 = (0);
var G__19038 = (0);
seq__19018 = G__19035;
chunk__19019 = G__19036;
count__19020 = G__19037;
i__19021 = G__19038;
continue;
}
} else {
...
});})(each_fixture_fn,G__19017,G__19017__$1,env,once_fixtures,each_fixtures,vec__19014,ns,vars__$1))
);
});})(each_fixture_fn,G__19017,G__19017__$1,env,once_fixtures,each_fixtures,vec__19014,ns,vars__$1))
], null);
