...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__19433 = cljs.core.second(format);
var G__19434 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__19433,G__19434) : ajax.easy.keyword_response_format_element.call(null,G__19433,G__19434));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__19435 = format;
var G__19435__$1 = (((G__19435 instanceof cljs.core.Keyword))?G__19435.fqn:null);
switch (G__19435__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19437_SHARP_){
return ajax.easy.keyword_response_format_element(p1__19437_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__19438){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19439__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19439__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19439__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__19439,map__19439__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__19441){
var vec__19442 = p__19441;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19442,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19442,(1),null);
var fexpr__19445_19446 = (cljs.core.truth_(ok)?h:e);
(fexpr__19445_19446.cljs$core$IFn$_invoke$arity$1 ? fexpr__19445_19446.cljs$core$IFn$_invoke$arity$1(result) : fexpr__19445_19446.call(null,result));
...
;})(h,e,map__19439,map__19439__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__19447){
var map__19448 = p__19447;
var map__19448__$1 = ((((!((map__19448 == null)))?(((((map__19448.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19448.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19448):map__19448);
var opts = map__19448__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19448__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19448__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19448__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19448__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19448__$1,cljs.core.cst$kw$body);
