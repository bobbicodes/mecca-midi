...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__19395){
var map__19396 = p__19395;
var map__19396__$1 = ((((!((map__19396 == null)))?(((((map__19396.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19396.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19396):map__19396);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19396__$1,cljs.core.cst$kw$handler);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3949__auto__ = p1__19398_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__19399){
var map__19400 = p__19399;
var map__19400__$1 = ((((!((map__19400 == null)))?(((((map__19400.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19400.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19400):map__19400);
var request = map__19400__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19400__$1,cljs.core.cst$kw$interceptors);
