...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__17554){
...
var handler = cljs.core.get.call(null,map__17555__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3949__auto__ = p1__17557_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__17558){
var map__17559 = p__17558;
var map__17559__$1 = ((((!((map__17559 == null)))?(((((map__17559.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17559.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__17559):map__17559);
var request = map__17559__$1;
var interceptors = cljs.core.get.call(null,map__17559__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
