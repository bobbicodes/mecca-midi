...
var o19642 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19642["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19643 = temp__5455__auto____$1;
return (o19643["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19462__auto__ = f;
return (o__19462__auto__["toString"]).call(o__19462__auto__);
} else {
return "";
}
}catch (e19644){var _ = e19644;
return "";
}});
...
try{var o__19462__auto___19646 = t;
(o__19462__auto___19646["cljs$lang$ctorPrWriter"]).call(o__19462__auto___19646,t,writer);
}catch (e19645){var __19647 = e19645;
}
...
var char_code = (function (){var o__19462__auto__ = (new String(char$));
return (o__19462__auto__["charCodeAt"]).call(o__19462__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19462__auto__ = String;
return (o__19462__auto__["fromCharCode"]).call(o__19462__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19648 = num_code;
switch (G__19648) {
case (1):
return (185);
...
var o__19462__auto__ = String;
return (o__19462__auto__["fromCharCode"]).call(o__19462__auto__,superscript_code);
});
/**
...
}catch (e19650){var _e__19469__auto__ = e19650;
return false;
}})())){
...
var vec__19651 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19651,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o19654 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19654["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19655 = temp__5455__auto____$1;
return (o19655["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___19662 = arguments.length;
var i__4532__auto___19663 = (0);
while(true){
if((i__4532__auto___19663 < len__4531__auto___19662)){
args__4534__auto__.push((arguments[i__4532__auto___19663]));

var G__19664 = (i__4532__auto___19663 + (1));
i__4532__auto___19663 = G__19664;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19658){
var vec__19659 = p__19658;
var ns_detector = cljs.core.nth.call(null,vec__19659,(0),null);
...
var G__19665 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19666 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19665;
remaining_tokens = G__19666;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19656){
...
var vec__19670 = cljs.core.split_with.call(null,(function (p1__19669_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19669_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19670,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19670,(1),null);
...
var vec__19673 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19673,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19673,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19676 = cljs.core.rest.call(null,remaining_tokens);
var G__19677 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19676;
name_tokens = G__19677;
continue;
} else {
...
var vec__19680 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19680,(0),null);
var arity = cljs.core.nth.call(null,vec__19680,(1),null);
var vec__19683 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19683,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19683,(1),null);
var vec__19686 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19686,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19686,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19686,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19686,(3),null);
...
var vec__19692 = result;
var munged_ns = cljs.core.nth.call(null,vec__19692,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19692,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19692,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19692,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19692,(4),null);
var arity = cljs.core.nth.call(null,vec__19692,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__19696 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__19696,(0),null);
var args = cljs.core.nth.call(null,vec__19696,(1),null);
var vec__19699 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__19702 = (arity + (1));
var G__19703 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19704){
var vec__19705 = p__19704;
var arity = cljs.core.nth.call(null,vec__19705,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19705,(1),null);
...
return cljs.core.get.call(null,arities,p1__19708_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19709_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19712){
var vec__19713 = p__19712;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19713,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19710){
var G__19711 = cljs.core.first.call(null,seq19710);
var seq19710__$1 = cljs.core.next.call(null,seq19710);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19711,seq19710__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19721__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19721__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19721__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19721__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19722 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19722,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19722,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19722,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19722,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19722,(4),null);
var arity = cljs.core.nth.call(null,vec__19722,(5),null);
...
var o__19462__auto__ = f;
return (o__19462__auto__["getBasis"]).call(o__19462__auto__);
});
/**
...
}catch (e19726){var _e__19469__auto__ = e19726;
...
var G__19727 = (obj[cljs.core.first.call(null,path)]);
var G__19728 = cljs.core.rest.call(null,path);
obj = G__19727;
path = G__19728;
continue;
} else {
...
return (function (accum,p__19729){
var vec__19730 = p__19729;
var bit = cljs.core.nth.call(null,vec__19730,(0),null);
var protocol = cljs.core.nth.call(null,vec__19730,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19733){
...
var selector = cljs.core.nth.call(null,vec__19734,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19739,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19739,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19739,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19737_SHARP_){
return (obj[cljs.core.first.call(null,p1__19737_SHARP_)]);
});})(name,sorted_matches,vec__19739,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
