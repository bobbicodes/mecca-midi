...
var G__20263 = devtools.prefs.pref.call(null,v);
v = G__20263;
continue;
} else {
return v;
...
}catch (e20266){var _e__19517__auto__ = e20266;
return false;
}})();
...
}catch (e20270){var _e__19517__auto__ = e20270;
return false;
}})();
...
}catch (e20272){var _e__19517__auto__ = e20272;
return false;
}}
}
});
...
var vec__20274 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20274,(0),null);
var name = cljs.core.nth.call(null,vec__20274,(1),null);
...
return cljs.core.some.call(null,(function (p1__20277_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20277_SHARP_);
}),template);
});
