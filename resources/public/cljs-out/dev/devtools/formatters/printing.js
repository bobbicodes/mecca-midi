...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20306){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20307,G__20308,seq20306__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20312_SHARP_){
return !((cljs.core.meta.call(null,p1__20312_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__20313__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20317){var _e__19517__auto__ = e20317;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20319){var _e__19517__auto__ = e20319;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20321 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20322 = opts;
var map__20322__$1 = ((((!((map__20322 == null)))?(((((map__20322.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20322.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20322):map__20322);
var markup_db = cljs.core.get.call(null,map__20322__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20321;
}});
...
;
var temp__5455__auto___20326 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20326)){
var managed_print_level_20327 = temp__5455__auto___20326;
var _STAR_print_level_STAR_20325_20328 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20327;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20325_20328,managed_print_level_20327,temp__5455__auto___20326,writer,opts,job_fn){
return (function (p1__20324_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20324_SHARP_,null);
});})(_STAR_print_level_STAR_20325_20328,managed_print_level_20327,temp__5455__auto___20326,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20325_20328;
}} else {
job_fn.call(null);
}
