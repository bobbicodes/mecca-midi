...
return cljs.core.reduce.call(null,(function (result,p__25416){
...
var vec__25420 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__25420,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__25420,(1),null);
var ab = cljs.core.nth.call(null,vec__25420,(2),null);
...
return (function (){var G__25429 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25429__$1)].join('')));
